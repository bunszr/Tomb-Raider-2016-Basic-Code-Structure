...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty deltaVectorSmoothTime;
    private SerializedProperty isClampedVisual;
    ...
    protected virtual void OnEnable()
    {
        ...
        deltaVectorSmoothTime = serializedObject.FindProperty("deltaVectorSmoothTime");
        isClampedVisual = serializedObject.FindProperty("isClampedVisual");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(deltaVectorSmoothTime, new GUIContent("deltaVectorSmoothTime", "sd"));
        EditorGUILayout.PropertyField(isClampedVisual, new GUIContent("isClampedVisual", "sd"));
    }
